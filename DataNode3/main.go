...
func (s *server) Intercambio(ctx context.Context, msg *pb.Message) (*pb.Message, error) {
	if msg.Body == "cierre" {
		...
		go exit("Se ha cerrado el dataNode3 (Cremator) satisfactoriamente")
		...
		return &pb.Message{Body: "Se ha recibido y guardado el mensaje en DataNode3 con exito."}, nil
	}
}
...
func main() {
	...
	//defer file.Close()
	listener, err := net.Listen("tcp", ":50069") //conexion sincrona
	if err != nil {
